                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nama_peminjam" type="text" id="nama_peminjam" class="form-control" placeholder="Nama Peminjam" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Pinjam</label>
                              <div class="col-sm-8">
                                  <input name="tgl_pinjam" type="text" id="tgl_pinjam" class="form-control" placeholder="Tanggal Pinjam" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Kembali</label>
                              <div class="col-sm-8">
                                  <input name="tgl_kembali" type="text" id="tgl_kembali" class="form-control" placeholder="Tanggal Kembali" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="ket" class="form-control" id="ket" type="text" placeholder="Keterangan" required />
                              </div>
                          </div>
